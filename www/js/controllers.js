...
// Popup logic ====================
  // .fromTemplate() method
  var template = "<ion-popover-view class='popover'><ion-header-bar class='grey-text'> <h1 class='title grey-text'>Info</h1> </ion-header-bar> <ion-content><br /><div class='popover-text'> Parking: <img src='img/parkingtrue.png' style='width:25px;height:25px' class='images'> <br /> Lifeguards: <img src='img/lifeguardtrue.png' style='width:25px;height:25px' class='images'> <br /> Restrooms: <img src='img/restroomtrue.png' style='width:25px;height:25px' class='images'> <br /> Surfing: <img src='img/surfingtrue.png' style='width:25px;height:25px' class='images'> <br /> Volleyball courts: <img src='img/volleyballtrue.png' style='width:25px;height:25px' class='images'> <br /> Animals allowed: <img src='img/animalstrue.png' style='width:25px;height:25px' class='images'> <br /> Fishing: <img src='img/fishingtrue.png' style='width:25px;height:25px' class='images'> <br /> Firepits: <img src='img/firepittrue.png' style='width:25px;height:25px' class='images'></div> <hr class='style-grey'/> <div class='popover-text'><p>Want to add to Barnacle or see something that isn't quite right? </p> <a class='button button-clear' ui-sref='app.SuggestionForm'>{{link.name}}</a>       </ion-content></ion-popover-view>";
